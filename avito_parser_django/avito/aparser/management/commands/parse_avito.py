...
#I:\pythonProjects\avito_django_telebot\avito_parser_django\avito>
...
class AvitoParser:
    ...
    def parse_block(self, item):
        ...
        #url_block = item.select_one('a.snippet-link') #div data-marker="item"  meta itemprop="description"
        url_block = item.select_one('data-marker.item"')  # div data-marker="item"  meta itemprop="description"
        if not url_block:
